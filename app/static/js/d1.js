    ...
    link.addEventListener("click", function (e) {
      ...
      routeSections.forEach((section) => {
        section.style.display =
          section.getAttribute("data-route") === route ? "block" : "none";
      });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    async function uploadFile() {
      ...
      try {
        ...
        uploadButton.innerHTML =
          '<span>ANALYZING...</span><div class="btn-pulse"></div>';
        ...
        uploadButton.innerHTML =
          '<span>INITIATE SCAN</span><div class="btn-pulse"></div>';
      }
    }
    ...
    function getSeverityClass(className) {
      ...
      if (
        className.toLowerCase().includes("high") ||
        className.toLowerCase().includes("malignant")
      ) {
        return "high";
  ...
  function displayResults(data) {
    ...
    const diagnosisElement = document.querySelector(".diagnosis-result");
    diagnosisElement.innerHTML = `
      <span class="severity ${getSeverityClass(
        data.prediction.class
      )}">${data.prediction.class.toUpperCase()}</span>
      <div class="confidence">
          <div class="confidence-bar" style="width: ${
            data.prediction.confidence * 100
          }%"></div>
